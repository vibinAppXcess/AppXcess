...
const HealthcareBlog2: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <section className="relative bg-gradient-to-br from-custom-blue via-custom-teal to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-center">
          <h1 className="text-4xl md:text-6xl font-black leading-tight mb-6">Streamlining Operations in Healthcare</h1>
          <p className="text-xl text-white/90">Lean processes, automation and better coordination across the care continuum.</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-lg text-gray-700 leading-relaxed">
          ...
          <p>Automate intake, scheduling and documentation to cut delays and free up clinical time.</p>
          <h2 className="text-2xl font-bold text-gray-900">Resource Optimization</h2>
          <p>Use data to balance staffing, beds and equipment while maintaining quality of care.</p>
          <h2 className="text-2xl font-bold text-gray-900">Integrated Care</h2>
          <p>Connect departments and partners to eliminate bottlenecks and duplicate effort.</p>
        </div>
      </section>

      <section className="py-16 bg-gradient-to-br from-custom-blue via-custom-teal to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-3xl font-bold mb-4">Make operations more efficient</h3>
...
export default HealthcareBlog2;
