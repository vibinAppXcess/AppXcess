        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow flex flex-col">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">IoT Integration for modern networks</h3>
              <p className="text-gray-600 mb-6 flex-grow">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <Link to="/Blog/Telecom-Data-Analytics" className="text-custom-teal font-semibold flex items-center gap-2 hover:gap-3 transition-all self-start">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <Link to="/Blog/Telecom-Big-Data" className="text-custom-teal font-semibold flex items-center gap-2 hover:gap-3 transition-all self-start">
                  Read More <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow:hidden hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <Link to="/Blog/Telecom-Decision-Impact" className="text-custom-teal font-semibold flex items-center gap-2 hover:gap-3 transition-all self-start">
                  Read More <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
