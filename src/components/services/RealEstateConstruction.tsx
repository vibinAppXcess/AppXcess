      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Industry Updates - Revolutionizing real estate and construction with cutting-edge technology, sustainable practices, and smarter solutions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <p className="text-gray-600 mb-4 flex-grow">
                  Discover how digital transformation is revolutionizing real estate operations and customer experiences.
                </p>
                <button className="text-custom-teal font-semibold flex items-center gap-2 hover:gap-3 transition-all self-start">
                  Read More <ArrowRight className="w-4 h-4" />
                </button>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Sustainable Practices in Modern Real Estate
                </h3>
                <p className="text-gray-600 mb-4 flex-grow">
                  Learn about sustainable practices and green technology implementation in modern real estate development.
                </p>
                <button className="text-custom-teal font-semibold flex items-center gap-2 hover:gap-3 transition-all self-start">
                  Read More <ArrowRight className="w-4 h-4" />
                </button>
